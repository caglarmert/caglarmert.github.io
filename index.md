---
layout: default
title: Ümit Mert Çağlar - PhD Candidate, Computer Vision & Generative Models
description: PhD Student & Research Assistant at METU Graduate School of Informatics. Research on computer vision, generative models, and large-scale Earth observation datasets.
---

<div class="hero">
  <img class="hero__photo" src="{{ '/1706702635109.jpg' | relative_url }}" alt="Ümit Mert Çağlar">
  <div>
    <h1 class="hero__name">Ümit Mert Çağlar</h1>
    <p class="hero__title">PhD Candidate · Research and Teaching Assistant</p>
    <p class="hero__org">Graduate School of Informatics, <a href="https://www.metu.edu.tr" target="_blank" rel="noopener">Middle East Technical University (METU)</a>, Ankara, Türkiye</p>
  </div>
</div>

<div class="contact-strip">
  <a href="https://github.com/caglarmert" target="_blank" rel="noopener">GitHub</a>
...
<section class="panel" markdown="1">
## <span class="section-title">Awards and Accomplishments</span>
